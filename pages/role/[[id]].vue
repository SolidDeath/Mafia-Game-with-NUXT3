...
<script setup lang="ts">
    ...
    */
        let serverRole = await useFetch("../../server/api/firestore/roles/" + props.id)
        console.log(serverRole.data);
        
        let serverActions = await useFetch('../api/firestroe/roles/' + props.id + "actions")
