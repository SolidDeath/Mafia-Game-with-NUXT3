...
<template>
  ...
  <nav :class="[mobileMenu?'transform translate-x-0':'transform translate-x-[150%] hidden','absolute transition-transform duration-200 w-screen h-screen bg-shallow md:hidden']">
